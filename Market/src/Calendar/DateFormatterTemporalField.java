 ...
 *
 * This class is a place holder for each date pattern element, for example each
 * yyyy is considered az a one temporal field. each object of this class has two
 * important value 'type' and 'count'. type shows type of each field and count
 * shows the number of it. for example 'mm' will be MONTH_FIELD and its count
 * will be two.
 *
 * This class is protected by this package and just will be used by
 * JalaliDateFormatter class.
 *
